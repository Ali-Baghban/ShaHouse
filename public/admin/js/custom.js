...
function template_functions(){
	...
	$('.datatable').dataTable({
			...
			"oLanguage": {
			"sLengthMenu": "_MENU_ records per cat"
			}
		} );
...
function widthFunctions(e) {
	...
	if (contentHeight) {
		...
		$("#sidebar-right2").css("height",contentHeight);
		
	}
    
	if (winWidth < 980 && winWidth > 767) {
		
		if($("#sidebar-right").hasClass("span2")) {
			
			$("#sidebar-right").removeClass("span2");
			$("#sidebar-right").addClass("span1");
		...
		if($("#sidebar-right").hasClass("span1")) {
			
			$("#sidebar-right").removeClass("span1");
			$("#sidebar-right").addClass("span2");
