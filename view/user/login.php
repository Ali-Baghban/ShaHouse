...
<head>
    ...
    <meta name="description" content="Sahroodut.ir">
    <meta name="author" content="Shahroodut.ir">
    <meta name="keyword" content="Shahroodut.ir, Ali Baghban, Ali Baghban Baghestan">
    <!-- end: Meta -->
    ...
    <style type="text/css">
        body{
            background: url(public/admin/image/bg-login.jpg) !important;
        }
    </style>
...
<div class="container-fluid-full">
    <div class="row-fluid">
        ...
        <div class="row-fluid">
            <div class="login-box">
                <div class="icons">
                    <a href="index.php?c=user&a=panel"><i class="halflings-icon home"></i></a>
                ...
                <form class="form-horizontal" action="" method="post">
                    <fieldset>
                        ...
                        <div class="input-prepend" title="Username">
                            ...
                            <input class="input-large span10" name="frm[email]" id="username" type="text"
                        ...
                        <div class="input-prepend" title="Password">
                            ...
                            <input class="input-large span10" name="frm[password]" id="password" type="password"
                                   placeholder="رمز عبور"/>
                        </div>
                        <div class="clearfix"></div>

                        <label class="remember" for="remember"><input type="checkbox" id="remember"
                                                                      name="frm[remember]"/>مرا بخاطر بسپار</label>

                        <div class="button-login">
                            <button type="submit" class="btn btn-primary" name="frm[btn]">ورود</button>
                        </div>
                        <div class="clearfix"></div>
                </form>
                <hr>
                <h3>فراموش کردن پسورد</h3>
                <p>
                    مشکلی نیست, <a href="index.php?c=user&a=reset">اینجا کلیک</a> کن تا پسوردت رو عوض کنی
                </p>
                <?php
                //
                ?>
...
<script src=public/admin/jsmodernizr.js"></script>
...
<script src=public/admin/jsexcanvas.js"></script>
