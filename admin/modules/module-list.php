    ...
    <div class="row-fluid sortable">
        <div class="box span12">
            <div class="box-header" data-original-title>
                <h2><i class="halflings-icon user"></i><span class="break"></span>ماژول ها</h2>
                <div class="box-icon">
            ...
            <div class="box-content">
                <table class="table table-striped table-bordered bootstrap-datatable datatable">
                    ...
                    <tbody>
                    <?php
                    if ($moduleslist = get_module_list()) {
                        ...
                        <td class="center">
                            ...
                            <a class="btn btn-info" href="dashboard.php?m=module-edit&id=$val[id]">
